...
namespace AirOS.Network.IPV4.UDP
{
    public class UDPPacket : IPPacket
    {
        ...
        public static bool CheckCRC(UDPPacket packet)
        {
            ...
            //Apps.System.Debugger.debugger.Send("Calculated: 0x" + Utilities.Conversion.DecToHex(calculatedcrc));
            //Apps.System.Debugger.debugger.Send("Received:  0x" + Utilities.Conversion.DecToHex(packet.udpCRC));
